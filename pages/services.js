...
export default function Services() {
    return (
        <div className='homepage mob-bg'>
            ...
            <section className='xl:pt-20 lg:pt-32 md:pt-24 pt-12 xl:pb-20 lg:pb-32 md:pb-30 pb-10'>
            <div className='top-star-object-service'>
          <img src='/meta/Metaversol Icon_LightPurple_OK 1.png' alt='start' />
        </div>
        <div className='bottom-star-object-service'>
          <img src='/meta/start-first-section.png' alt='start-first-section.png' />
                 ...
                 <div className='position-relative max-w-7xl mx-auto px-4'>
                    <div className="grid grid-cols-12 xl:gap-12 lg:gap-8 gap-4">
                        ...
                        <div className="lg:col-span-7 col-span-12">
                            ...
                            <div>
                  <img src='/assets/images/glob-Cta.png' alt='ChainCta' />
                </div>
                        </div>
                    </div>
            ...
            <section className='xl:pt-10 lg:pt-10 md:pt-10 pt-12'>
            <div className='expanse-object-services'>
            <img src='/meta/Metaversol Icon_LightPurple_OK 1.png' alt='start' />
        </div>
                <div className='position-relative max-w-7xl mx-auto px-4'>
                    ...
                    <div className='position-relative flex md:flex-row flex-col lg:gap-16 gap-4 mb-10'>
                        <div style={{ flex: '6' }}>
                            <div className='flex md:text-left text-center justify-items-center md:flex-row flex-col lg:gap-8 gap-4'>
                                <div className='flex md:justify-start justify-center items-start'>
                                    <img className='object-none md:w-media-w-img-2 w-media-w-img-1 md:min-w-media-img-2 min-w-media-img-1' src='/assets/images/mediaIcon.png' alt=""></img>
                        ...
                        <div className='expanse-object-services-2'>
                        <img src='/meta/start-first-section.png' alt='start-first-section.png' />
        </div>
                    </div>
            ...
            <section className='position-relative xl:pt-20 lg:pt-32 md:pt-24 pt-12'>
            <div className='expanse-object-services-3'>
                        <img src='/assets/images/world-purple.png' alt='start-first-section.png' />
        </div>
