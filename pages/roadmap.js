...
export default function RoadMap() {
    return (
        <div className='homepage mob-bg'>
            ...
            <section className='xl:pt-30 lg:pt-32 md:pt-24 pt-12 xl:pb-0 lg:pb-0 md:pb-30 pb-40'>
                <div className='mx-auto px-4'>
                <div className='top-star-object'>
          <img src='/meta/Metaversol Icon_LightPurple_OK 1.png' alt='start' />
        </div>
        <div className='bottom-star-object-roadmap'>
        ...
        <div className='position-relative max-w-7xl mx-auto px-4'>
                    <div className="grid grid-cols-12 xl:gap-12 lg:gap-8 gap-4">
                        ...
                        <div className="md:col-span-7 col-span-12 flex  items-center ">
                            <div className='text-left w-full '>
                  <img src='/assets/images/RoadMap-cta.png' alt='ChainCta' />
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            <section className='xl:pt-40 lg:pt-32 md:pt-24 pt-12'>
                <div className='position-relative max-w-7xl mx-auto px-4'>
                    <div className='lg:mb-24 mb-8'>
                        ...
                        <div className='top-star-object-pass'>
          <img src='/meta/Metaversol Icon_LightPurple_OK 1.png' alt='start' />
        </div>
                    </div>
                    ...
                    <div className="position-relative flex justify-around items-center lg:flex-nowrap flex-wrap lg:gap-12 gap-4">
                    <div className='expanse-object-roadmap-3'>
